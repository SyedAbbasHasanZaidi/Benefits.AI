export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-6 p-8 bg-gray-950">
      <h1 className="text-4xl font-bold tracking-tight text-white">Benefits.AI</h1>
      <p className="max-w-md text-center text-gray-400">
        Discover Australian government entitlements you may qualify for — federal, state, and local.
      </p>
      <a
        href="/chat"
        className="rounded-lg bg-blue-600 px-6 py-3 text-white font-medium hover:bg-blue-500 transition-colors"
      >
