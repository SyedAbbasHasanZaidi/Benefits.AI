...
function SettingsMenu({ onHowItWorks, onSignIn }: { onHowItWorks: () => void; onSignIn: () => void }) {
  ...
  const items: MenuItem[] = [
    { icon: 'User',          label: 'Profile',                  locked: !user,  onClick: () => setOpen(false) },
    { icon: 'Book',          label: 'Resources',                                onClick: () => setOpen(false) },
    { icon: 'Bell',          label: 'Notification preferences', locked: !user,  onClick: () => setOpen(false) },
    { icon: 'Accessibility', label: 'Accessibility settings',                   onClick: () => setOpen(false) },
    { icon: 'Lock',          label: 'Privacy & data',           locked: !user,  onClick: () => setOpen(false) },
    { icon: 'Help',          label: 'Help & support',                           onClick: () => setOpen(false) },
  ]
